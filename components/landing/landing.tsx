...
export function Laserlanding() {
  ...
  const copy = getDictionary(locale).landing.hero;
  ...
  return (
    <div
      ...
      onMouseMove={(e: { currentTarget: { getBoundingClientRect: () => any; }; clientX: number; clientY: number; }) => {
    ...
    >
      ...
      >
        ...
        >
          <GlowButton href="/dashboard" label={copy.primaryCta} />
        </motion.div>
